...
<html>
    ...
    <body>
        ...
        <h1><%=titulo%></h1>
        <form action="./webresources/generic/modify" method="POST">
                <p>Titulo: <input type="text" name="title" value="<%=titulo%>" required></p>
        	<p>Descripcion: <input type="text" name="description" value="<%=descripcion%>" required></p>
        	<p>Palabras clave: <input type="text" name="keywords" value="<%=palabras_clave%>" placeholder="Palabras separadas con ';'" required></p>        	
                <p><label for="date">Fecha creación:</label>
                    <input type="date" name="crea_date" value="<%=fecha_creacion%>" required></p>  
